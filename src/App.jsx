...
function App() {
  ...
  return (
    <>
      <Navbar />
      <div className="mx-3 md:container md:mx-auto my-5 md:w-[40%] p-4 rounded-xl bg-violet-100 min-h-[80vh]">
      <h1 className='font-black text-center text-xl'>iTask - Manage your todos at one place</h1>
        <div className="addTodo my-5 flex flex-col gap-4">
          <h2 className='text-xl font-bold'>Add a todo</h2>
          <div className="flex">
          <input onChange={handleChange} value={todo} type="text" className='bg-white w-full rounded-full px-5 py-1' />
          <button onClick={handleAdd} disabled={todo.length<=3} className='bg-violet-800 hover:bg-violet-950 disabled:bg-violet-700 p-4 py-2 mx-2 text-sm font-bold text-white rounded-full'>Save</button>
          </div>
        </div>
